...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Creator Confirmation</title>
    <style>
      body {
        font-family: Arial, sans-serif;
        line-height: 1.6;
  ...
  <body>
    <div class="container">
      <h1>Creator Confirmation</h1>
      <p>Dear ${creator_name},</p>
      <p>
        Congratulations! You have been successfully registered as a Creator on
        our website.
      </p>
      <p>
        As a Creator, you can now showcase your artworks to our audience and
